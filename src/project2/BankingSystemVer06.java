...
import project2.ver06.Game;
import project2.ver06.MenuChoice;
import project2.ver06.MenuSelectException;

public class BankingSystemVer06 implements MenuChoice{
	...
	public static void main(String[] args) {
		...
		while(true) {
			System.out.println(
					"=================================Menu================================\n"
							+ "  1.계좌개설  2.입금  3.출금  4.전체계좌정보출력  5.저장옵션  6.3by3 게임시작  7.프로그램종료\n"
							+   "=====================================================================");
		...
		if(a == 1) {
			if(inputMenu<1 || inputMenu > 7) {
				...
				MenuSelectException ex = 
						new MenuSelectException(">>1부터 7까지의 정수만 입력하세요.\n");
				throw ex;
			}
		}
		// 2. 서브메뉴 (계좌종류선택 등) 예외 감지
		else if(a == 2) {
			if(inputMenu != 1 && inputMenu != 2) {
				//예외객체를 생성한 후 프로그램으로 throw 한다.
				MenuSelectException ex = 
						new MenuSelectException("1과 2만 입력하세요.\n");
				throw ex;
			}			
		}
